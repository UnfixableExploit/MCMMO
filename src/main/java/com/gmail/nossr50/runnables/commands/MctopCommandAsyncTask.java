...
public class MctopCommandAsyncTask extends BukkitRunnable {
    ...
    public MctopCommandAsyncTask(int page, SkillType skill, CommandSender sender, boolean useChat) {
    ...
    public void run() {
        ...
        new MctopCommandDisplayTask(userStats, page, skill, sender, useChat).runTaskLater(mcMMO.p, 1);
    }
}
